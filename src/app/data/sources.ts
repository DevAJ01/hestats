...
export const DATA_SOURCES: DataSourceDef[] = [
  ...
  },
  {
    ...
    publisher: 'Office for Students',
    publisher_url: 'https://www.officeforstudents.org.uk',
    dataset: 'Teaching Excellence Framework (TEF) ratings and data dashboard',
    dataset_url: 'https://www.officeforstudents.org.uk/for-providers/quality-and-standards/tef-2023-ratings/',
    description: 'Official OfS TEF provider ratings and supporting TEF data dashboard indicators. HEStats treats TEF ratings as assessment ratings, not annual rankings.',
    licence: 'OGL-3.0',
    licence_url: 'https://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/',
    update_frequency: 'Periodic TEF assessment, with dashboard indicator refreshes',
    methodology_url: 'https://www.officeforstudents.org.uk/for-providers/quality-and-standards/about-the-tef/',
    known_limitations: [
      'TEF ratings are not annual league-table rankings',
      'The 2023 ratings normally last for four years until the next TEF exercise',
      'Provider ratings must be imported from official OfS rows before being shown as verified',
    ],
    coverage: 'TEF 2023 ratings; TEF data dashboard current extract last updated February 2026',
  },
  {
    id: 'ofs-afr',
    tier: 4,
